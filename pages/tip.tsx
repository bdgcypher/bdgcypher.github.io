        ...
        <div onLoad={() => { observePage() }}>
            ...
            <div>
                <div id="home" className="pt-4 pl-4 bg-white dark:bg-black">
                    <a href="/projects" aria-label="back button to projects page" className="text-primary dark:text-primaryDark hover:text-secondary text-4xl transition ease-in-out duration-300">
                        <BiArrowBack />
                    </a>
